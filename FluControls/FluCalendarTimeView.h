...
class FluCalendarTimeView : public FluWidget
{
    Q_OBJECT
  public:
    FluCalendarTimeView(QWidget* parent = nullptr);
    ...
    QTime getCurTime()
    {
        return m_timePicker->getCurTime();
    }

    void setCurTime(QTime time)
    {
        m_timePicker->setCurTime(time);
    }
