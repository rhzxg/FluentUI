...
FluVNavigationSearchItem::FluVNavigationSearchItem(QWidget* parent /*= nullptr*/) : FluVNavigationItem(parent)
{
    ...
    FluStyleSheetUitls::setQssByFileName("/resources/qss/light/FluVNavigationSearchItem.qss", this);
...
void FluVNavigationSearchItem::onThemeChanged()
{
    ...
    else
    {
        ...
        FluStyleSheetUitls::setQssByFileName("/resources/qss/dark/FluVNavigationSearchItem.qss", this);
    }
}
