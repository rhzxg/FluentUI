...
FluCalendarTimeView::FluCalendarTimeView(QWidget* parent /*= nullptr*/)
    : FluWidget(parent)
{
    ...
    m_timePicker = new FluTimePicker24H(true);
    m_vMainLayout->addWidget(m_timePicker);
    ...
    connect(m_timePicker, &FluTimePicker24H::selectedTime, this, [=](QTime time) {
        emit selectedTime(time);
    });

    // setFixedWidth(300);
    setFixedSize(300, 400);
    FluStyleSheetUitls::setQssByFileName("/resources/qss/light/FluCalendarTimeView.qss", this);
}

void FluCalendarTimeView::switchSelectViewState(FluCalendarViewState state)
{
    switch (state)
    {
        case FluCVS_SelectDayView:
...
void FluCalendarTimeView::switchSelectDayView()
{
    m_viewState = FluCVS_SelectDayView;
    m_sLayout->setCurrentWidget(m_selectDayView);
}

void FluCalendarTimeView::switchSelectMonthView()
{
    m_viewState = FluCVS_SelectMonthView;
...
void FluCalendarTimeView::switchSelectYearView()
{
    m_viewState = FluCVS_SelectYearView;
...
FluCalendarSelectDayView* FluCalendarTimeView::getSelectDayView()
{
    return m_selectDayView;
}

FluCalendarSelectMonthView* FluCalendarTimeView::getSelectMonthView()
{
    return m_selectMonthView;
}

FluCalendarSelectYearView* FluCalendarTimeView::getSelectYearView()
{
    return m_selectYearView;
}

void FluCalendarTimeView::onThemeChanged()
{
    ...
    {
        FluStyleSheetUitls::setQssByFileName("/resources/qss/dark/FluCalendarTimeView.qss", this);
        //   style()->polish(this);
    }
}
