...
FluVNavigationFlyIconTextItem::FluVNavigationFlyIconTextItem(QWidget* parent /*= nullptr*/) : FluWidget(parent)
{
    ...
    // FluStyleSheetUitls::setQssByFileName("/resources/qss/light/FluNavigationFlyIconTextItem.qss", m_widget);
    // FluStyleSheetUitls::setQssByFileName("/resources/qss/light/FluNavigationFlyIconTextItem.qss", this);
    onThemeChanged();
}
...
void FluVNavigationFlyIconTextItem::onThemeChanged()
{
    ...
    {
        FluStyleSheetUitls::setQssByFileName("/resources/qss/dark/FluVNavigationFlyIconTextItem.qss", m_widget);
        FluStyleSheetUitls::setQssByFileName("/resources/qss/dark/FluVNavigationFlyIconTextItem.qss", this);
    }
}
