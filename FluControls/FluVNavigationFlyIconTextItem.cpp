...
void FluVNavigationFlyIconTextItem::onThemeChanged()
{
    ...
    {
        FluStyleSheetUitls::setQssByFileName("/resources/qss/light/FluVNavigationFlyIconTextItem.qss", m_vScrollView);
        FluStyleSheetUitls::setQssByFileName("/resources/qss/light/FluVNavigationFlyIconTextItem.qss", this);
    }
    else
    {
        FluStyleSheetUitls::setQssByFileName("/resources/qss/dark/FluVNavigationFlyIconTextItem.qss", m_vScrollView);
