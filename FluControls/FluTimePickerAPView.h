...
class FluTimePickerAPView : public FluWidget
{
  ...
  public:
    FluTimePickerAPView(QWidget* parent = nullptr) : FluWidget(parent), m_bAm(true), m_hour(0), m_minute(0), m_bFirstShow(true)
    {
        ...
        FluStyleSheetUitls::setQssByFileName("/resources/qss/light/FluTimePickerAPView.qss", this);
    }
  ...
  public slots:
    void onThemeChanged()
    {
        ...
        else
        {
            ...
            FluStyleSheetUitls::setQssByFileName("/resources/qss/dark/FluTimePickerAPView.qss", this);
        }
    }
