...
class FluTimePickerAP : public FluWidget
{
  ...
  public:
    FluTimePickerAP(QWidget* parent = nullptr) : FluWidget(parent)
    {
        ...
        FluStyleSheetUitls::setQssByFileName("/resources/qss/light/FluTimePickerAP.qss", this);
    }
  ...
  public slots:
    void onThemeChanged()
    {
        ...
        {
            FluStyleSheetUitls::setQssByFileName("/resources/qss/dark/FluTimePickerAP.qss", this);
        }
    }
